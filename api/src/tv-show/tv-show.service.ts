...
export class TvShowService {
    ...
    async updateTvShow(id: number, tvShowDetails: CreateTvShowDto): Promise<TvShow> {
        ...
        const newShow = await this.tvShowRepository.save(
            { id: Number(id), name: tvShow.name, photo: tvShow.description, description: tvShow.description, length: tvShow.length, trailer: tvShow.trailer, country: tvShow.trailer, genres: tvShow.genres }
        )
