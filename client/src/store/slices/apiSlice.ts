...
export const apiSlice = createApi({
  ...
  endpoints: (builder) => ({
    ...
    ratingOfShowByUser: builder.mutation<
      Object,
      { user: number; show: number }
    >({
      query: (args) => {
        const headers = {
          "Content-Type": "application/json",
    ...
    getRatingOfShowByUser: builder.query<
      Rating,
      { user: number; show: number }
    >({
      query(args) {
    ...
    getRatingOfShowByUserMut: builder.mutation<
      Rating,
      { user: number; show: number }
    >({
      query(args) {
    ...
    findShowProgressByUserByShow: builder.mutation<
      Array<Object>,
      { user: number; show: number }
    >({
      query: (args) => {
